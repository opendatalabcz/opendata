 ...
 */
@Component
public class TripleSplitIdentifierSetter implements RecordPropertyConverter{
    @Override
    ...
    public String getIdentifierFromSourceValues(Map<String, Cell> sourceValues) {
        Double year = sourceValues.get("inputYear").getNumericCellValue();
        ...
        String yearNumberString = Integer.toString(year.intValue());

        return yearNumberString + "-" + categoryCode + "-" + serialNumberString;
    }
}
