package eu.profinit.opendata.transform.convert.mvcr;
...
/**
 * Retrieves MV invoices based on the partner name, subject and originalCurrencyAmount. Only an exact match in all
 * considered attributes counts.
 * Throws a FATAL exception if more than one candidate record is found.
 */
@Component
public class MVInvoiceRetriever implements RecordRetriever {
